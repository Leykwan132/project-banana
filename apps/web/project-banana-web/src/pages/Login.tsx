        ...
        <div className="min-h-screen bg-[#fafafa] flex flex-col items-center justify-center p-6 animate-in fade-in duration-500 relative">
            ...
            <div className="w-full max-w-[320px] text-center">
                ...
                <div className="flex flex-col gap-2.5">
                    <button
                        onClick={signIn}
                        className="w-full flex items-center justify-center gap-2.5 bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-semibold text-gray-900 hover:bg-gray-50 transition-colors shadow-[0_1px_2px_rgba(0,0,0,0.02)]"
                    >
