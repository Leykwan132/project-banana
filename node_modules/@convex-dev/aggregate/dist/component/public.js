...
export const init = mutation({
    ...
    handler: async (ctx, { maxNodeSize, rootLazy, namespace }) => {
        ...
        await getOrCreateTree(ctx.db, namespace, maxNodeSize ?? DEFAULT_MAX_NODE_SIZE, rootLazy ?? true);
    },
});
/**
...
export const clear = mutation({
    ...
    handler: async (ctx, { maxNodeSize, rootLazy, namespace }) => {
        ...
        await getOrCreateTree(ctx.db, namespace, maxNodeSize ?? existingMaxNodeSize, rootLazy ?? existingRootLazy);
    },
});
